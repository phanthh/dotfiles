...
local sysinfo_widget = EphemeralWidget.new({
	label = "sysinfo",
	lines = sysinfo,
	win_opts = {
		relative = "win",
...
sysinfo_widget:render()

vim.wo[sysinfo_widget.win].winblend = WINBLEND
...
local news_widget = EphemeralWidget.new({
	label = "news",
	lines = news,
	win_opts = {
		relative = "win",
...
vim.wo[news_widget.win].winblend = WINBLEND
...
vim.wo[keyboard_widget.win].winblend = WINBLEND
...
local tools_widget = EphemeralWidget.new({
	label = "tools",
	lines = tools,
	win_opts = {
		relative = "win",
...
vim.wo[tools_widget.win].winblend = WINBLEND
...
local features_widget = EphemeralWidget.new({
	label = "features",
	lines = features,
	win_opts = {
		relative = "win",
...
features_widget:render()

vim.wo[features_widget.win].winblend = WINBLEND
