...
local on_attach = function(client, bufnr)
	...
	km("n", "gD", "<cmd>lua vim.lsp.buf.declaration()<cr>")
	km("n", "gd", "<cmd>lua vim.lsp.buf.definition()<cr>")
	km("n", "K", "<cmd>lua vim.lsp.buf.hover()<cr>")
	km("n", "gi", "<cmd>lua vim.lsp.buf.implementation()<cr>")
	...
	km("n", "gr", "<cmd>lua vim.lsp.buf.references()<cr>")
