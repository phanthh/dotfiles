...
km("n", "<leader>gR", "<cmd>Gitsigns reset_buffer<cr>")
km("n", "<leader>gf", "<cmd>DiffviewOpen<cr>")
km("n", "<leader>gF", "<cmd>DiffviewClose<cr>")

km({ "n", "v" }, "<leader>hs", "<cmd>Gitsigns stage_hunk<cr>")
km({ "n", "v" }, "<leader>hr", "<cmd>Gitsigns reset_hunk<cr>")
km("n", "<leader>hu", "<cmd>Gitsigns undo_stage_hunk<cr>")
km("n", "<leader>hp", "<cmd>Gitsigns preview_hunk<cr>")
