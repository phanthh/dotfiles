...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'surround.nvim', 'cmp_luasnip', 'cmp-path', 'cmp-nvim-lsp', 'cmp-cmdline', 'cmp-dictionary', 'cmp-buffer', 'nvim-lspconfig', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
