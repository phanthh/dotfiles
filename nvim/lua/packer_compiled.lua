...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'nvim-lspconfig', 'cmp-nvim-lsp', 'nvim-cmp', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer', 'LuaSnip', 'surround.nvim', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
