...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'LuaSnip', 'surround.nvim', 'cmp-path', 'nvim-lspconfig', 'nvim-cmp', 'cmp-nvim-lsp', 'cmp_luasnip', 'cmp-dictionary', 'cmp-cmdline'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
