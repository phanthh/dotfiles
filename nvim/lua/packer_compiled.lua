...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'surround.nvim', 'cmp-nvim-lsp', 'cmp-dictionary', 'nvim-cmp', 'cmp-cmdline', 'cmp_luasnip', 'cmp-buffer', 'cmp-path', 'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
