...
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'nvim-colorizer.lua', 'indent-blankline.nvim', 'gitsigns.nvim', 'lualine.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'nvim-colorizer.lua', 'indent-blankline.nvim', 'gitsigns.nvim', 'lualine.nvim'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'nvim-colorizer.lua', 'indent-blankline.nvim', 'gitsigns.nvim', 'lualine.nvim'}, { ft = "scss" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'nvim-lspconfig', 'cmp_luasnip', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer', 'LuaSnip', 'surround.nvim', 'nvim-cmp', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
