...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp_luasnip', 'nvim-lspconfig', 'surround.nvim', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer', 'cmp-nvim-lsp', 'cmp-path', 'LuaSnip', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
