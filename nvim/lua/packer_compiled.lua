...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-dictionary", "cmp-path", "cmp-nvim-lsp", "cmp-cmdline" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
