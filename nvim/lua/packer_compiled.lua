...
vim.cmd [[au FileType python ++once lua require("packer.load")({'jupyter_ascending.vim', 'gitsigns.nvim', 'lualine.nvim', 'indent-blankline.nvim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'nvim-colorizer.lua', 'gitsigns.nvim', 'lualine.nvim', 'indent-blankline.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'nvim-colorizer.lua', 'gitsigns.nvim', 'lualine.nvim', 'indent-blankline.nvim'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'nvim-colorizer.lua', 'gitsigns.nvim', 'lualine.nvim', 'indent-blankline.nvim'}, { ft = "scss" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-dictionary', 'cmp-buffer', 'nvim-cmp', 'cmp-nvim-lsp', 'cmp_luasnip', 'cmp-path', 'surround.nvim', 'cmp-cmdline'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
