...
vim.cmd [[au FileType python ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'jupyter_ascending.vim', 'lualine.nvim'}, { ft = "python" }, _G.packer_plugins)]]
