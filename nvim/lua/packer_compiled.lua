...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-nvim-lsp', 'cmp-dictionary', 'cmp-cmdline', 'nvim-cmp', 'surround.nvim', 'cmp-buffer', 'cmp-path', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
