...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp_luasnip', 'surround.nvim', 'LuaSnip', 'nvim-lspconfig', 'nvim-cmp', 'cmp-path', 'cmp-nvim-lsp', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
