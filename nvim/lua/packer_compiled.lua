...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-dictionary", "cmp-path", "cmp-nvim-lsp", "cmp_luasnip", "cmp-buffer" },
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'indent-blankline.nvim', 'jupyter_ascending.vim', 'gitsigns.nvim'}, { ft = "python" }, _G.packer_plugins)]]
