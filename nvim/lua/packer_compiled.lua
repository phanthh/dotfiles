...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'LuaSnip', 'cmp_luasnip', 'surround.nvim', 'cmp-path', 'nvim-lspconfig', 'cmp-nvim-lsp', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
