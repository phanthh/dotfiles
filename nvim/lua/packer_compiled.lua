...
vim.cmd [[au FileType scss ++once lua require("packer.load")({'lualine.nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim'}, { ft = "scss" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'lualine.nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim'}, { ft = "css" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'lualine.nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer', 'LuaSnip', 'surround.nvim', 'cmp_luasnip', 'nvim-cmp', 'cmp-path', 'nvim-lspconfig', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
