...
vim.cmd [[au FileType python ++once lua require("packer.load")({'lualine.nvim', 'jupyter_ascending.vim', 'gitsigns.nvim', 'indent-blankline.nvim'}, { ft = "python" }, _G.packer_plugins)]]
