...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'LuaSnip', 'cmp_luasnip', 'cmp-buffer', 'cmp-dictionary', 'cmp-path', 'cmp-cmdline', 'nvim-lspconfig', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
