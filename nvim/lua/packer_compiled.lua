...
vim.cmd [[au FileType python ++once lua require("packer.load")({'indent-blankline.nvim', 'lualine.nvim', 'jupyter_ascending.vim', 'gitsigns.nvim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-colorizer.lua', 'lualine.nvim', 'gitsigns.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-colorizer.lua', 'lualine.nvim', 'gitsigns.nvim'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-colorizer.lua', 'lualine.nvim', 'gitsigns.nvim'}, { ft = "scss" }, _G.packer_plugins)]]
