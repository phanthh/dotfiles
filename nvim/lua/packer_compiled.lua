...
vim.cmd [[au FileType python ++once lua require("packer.load")({'jupyter_ascending.vim', 'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'cmp-cmdline', 'cmp-buffer', 'surround.nvim', 'cmp_luasnip', 'cmp-path', 'cmp-dictionary', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
