...
_G.packer_plugins = {
  ...
  ["formatter.nvim"] = {
    config = { "\27LJ\2\n7\0\0\2\0\3\0\0045\0\0\0005\1\1\0=\1\2\0L\0\2\0\targs\1\2\0\0\6-\1\0\2\nstdin\2\bexe\vstylua?\0\0\2\0\3\0\0045\0\0\0005\1\1\0=\1\2\0L\0\2\0\targs\1\2\0\0\6-\1\0\2\nstdin\2\bexe\19/usr/bin/black©\1\0\0\a\0\b\0\0145\0\0\0005\1\1\0006\2\2\0009\2\3\0029\2\4\0026\4\2\0009\4\5\0049\4\6\4)\6\0\0B\4\2\0A\2\0\2>\2\2\1=\1\a\0L\0\2\0\targs\22nvim_buf_get_name\bapi\16fnameescape\afn\bvim\1\4\0\0\21--stdin-filepath\0\19--single-quote\1\0\2\nstdin\2\bexe\rprettier \1\1\0\6\0\f\0\0216\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\n\0005\3\4\0004\4\3\0003\5\3\0>\5\1\4=\4\5\0034\4\3\0003\5\6\0>\5\1\4=\4\a\0034\4\3\0003\5\b\0>\5\1\4=\4\t\3=\3\v\2B\0\2\1K\0\1\0\rfiletype\1\0\0\20typescriptreact\0\vpython\0\blua\1\0\0\0\nsetup\14formatter\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["sxhkd-vim"] = {
    loaded = true,
    path = "/home/phanthh/.local/share/nvim/site/pack/packer/start/sxhkd-vim",
...
vim.cmd [[au FileType dart ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "dart" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType r ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "r" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'jupyter_ascending.vim', 'lualine.nvim'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType rs ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "rs" }, _G.packer_plugins)]]
vim.cmd [[au FileType scala ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "scala" }, _G.packer_plugins)]]
vim.cmd [[au FileType cpp ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "cpp" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascriptreact ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "javascriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "c" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'lualine.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'lualine.nvim'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'lualine.nvim'}, { ft = "scss" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lualine.nvim'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'formatter.nvim', 'tidy.nvim'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-lspconfig', 'surround.nvim', 'cmp-nvim-lsp', 'cmp-buffer', 'cmp_luasnip', 'cmp-dictionary', 'cmp-cmdline', 'LuaSnip', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
