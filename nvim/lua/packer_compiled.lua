...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-dictionary", "cmp-nvim-lsp", "cmp_luasnip", "cmp-buffer", "cmp-path", "cmp-cmdline" },
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Telekasten lua require("packer.load")({'telekasten.nvim', 'telescope.nvim'}, { cmd = "Telekasten", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'lualine.nvim', 'indent-blankline.nvim', 'jupyter_ascending.vim', 'gitsigns.nvim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'lualine.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'gitsigns.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'lualine.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'gitsigns.nvim'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'lualine.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'gitsigns.nvim'}, { ft = "scss" }, _G.packer_plugins)]]
