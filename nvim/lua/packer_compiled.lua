...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-lspconfig', 'cmp_luasnip', 'nvim-cmp', 'cmp-nvim-lsp', 'cmp-cmdline', 'cmp-buffer', 'LuaSnip', 'surround.nvim', 'cmp-dictionary', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
