...
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'gitsigns.nvim', 'lualine.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType css ++once lua require("packer.load")({'gitsigns.nvim', 'lualine.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim'}, { ft = "css" }, _G.packer_plugins)]]
vim.cmd [[au FileType scss ++once lua require("packer.load")({'gitsigns.nvim', 'lualine.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim'}, { ft = "scss" }, _G.packer_plugins)]]
