...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-dictionary', 'cmp-nvim-lsp', 'nvim-cmp', 'cmp-buffer', 'cmp-cmdline', 'surround.nvim', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'faster.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'cmp-path', 'cmp-dictionary', 'cmp-nvim-lsp', 'nvim-cmp', 'cmp-buffer', 'tidy.nvim', 'cmp-cmdline', 'cmp_luasnip'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
