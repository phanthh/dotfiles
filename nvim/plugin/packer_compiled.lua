...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp_luasnip', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer', 'surround.nvim', 'nvim-cmp', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au WinLeave * ++once lua require("packer.load")({'shade.nvim'}, { event = "WinLeave *" }, _G.packer_plugins)]]
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'cmp-path', 'cmp_luasnip', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer', 'nvim-cmp', 'cmp-nvim-lsp'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
