...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp_luasnip', 'cmp-dictionary', 'cmp-cmdline', 'surround.nvim', 'cmp-buffer', 'nvim-cmp', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
