...
vim.cmd [[au FileType python ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-colorizer.lua', 'nvim-colorizer.lua', 'jupyter_ascending.vim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'cmp-nvim-lsp', 'cmp-path', 'cmp_luasnip', 'cmp-dictionary', 'surround.nvim', 'cmp-cmdline', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au TermOpen * ++once lua require("packer.load")({'vim-sendtowindow'}, { event = "TermOpen *" }, _G.packer_plugins)]]
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'nvim-cmp', 'cmp-nvim-lsp', 'cmp-path', 'cmp_luasnip', 'cmp-dictionary', 'cmp-cmdline', 'cmp-buffer'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
