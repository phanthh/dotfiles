...
vim.cmd [[au FileType python ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'jupyter_ascending.vim', 'nvim-colorizer.lua', 'nvim-colorizer.lua'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'surround.nvim', 'cmp-path', 'cmp-dictionary', 'cmp-buffer', 'cmp_luasnip', 'nvim-cmp', 'cmp-nvim-lsp', 'cmp-cmdline'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'cmp-path', 'cmp-dictionary', 'tidy.nvim', 'cmp-buffer', 'cmp_luasnip', 'nvim-cmp', 'cmp-nvim-lsp', 'cmp-cmdline'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
