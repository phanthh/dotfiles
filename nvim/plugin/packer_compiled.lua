...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-cmdline", "cmp-buffer", "cmp-path", "cmp-dictionary", "cmp_luasnip" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'surround.nvim', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
