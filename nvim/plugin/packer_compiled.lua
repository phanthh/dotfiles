...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    config = { "\27LJ\2\n¶\1\0\0\6\0\b\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0004\4\3\0005\5\3\0>\5\1\4=\4\5\3=\3\a\2B\0\2\1K\0\1\0\foptions\1\0\0\foffsets\1\0\0\1\0\4\15text_align\tleft\rfiletype\rNvimTree\ttext\18File Explorer\14highlight\14Directory\nsetup\15bufferline\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufWritePre * ++once lua require("packer.load")({'cmp-path', 'nvim-cmp', 'cmp-dictionary', 'cmp_luasnip', 'cmp-nvim-lsp', 'cmp-buffer', 'cmp-cmdline'}, { event = "BufWritePre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'nvim-cmp', 'cmp-dictionary', 'cmp_luasnip', 'cmp-nvim-lsp', 'cmp-buffer', 'surround.nvim', 'cmp-cmdline'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
